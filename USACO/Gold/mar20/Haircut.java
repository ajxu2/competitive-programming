// created: 06-23-2022 Thu 11:52 AM
...
public class Haircut {
    public static void main(String[] args) throws IOException {
        FastIO io = new FastIO("haircut.in", "haircut.out");
        int n = io.nextInt();
        long[] ans = new long[n+5];
        BIT b = new BIT(n+5);
        for (int i = 0; i < n; i++) {
            // INCREMENT ALL HAIR LENGTHS BY 1
            int a = io.nextInt()+1;
            b.add(a, 1);
            long inv = b.qry(a+1, n+5);
            ans[a+1] += inv; ans[n+4] -= inv;
        }
